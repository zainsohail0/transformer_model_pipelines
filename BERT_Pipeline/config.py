"""Configuration file for BERT antimicrobial peptide prediction pipeline."""
...
def get_config():
    ...
    parser = argparse.ArgumentParser(description='BERT Antimicrobial Peptide Prediction Pipeline')
